...
4. Connect to TOR and browse a few sites. For example:
   ...
   - Current Dread Forum: ``` dreadyj7l26jqvyk3xycgljkkagc32x2y5urlcse3qocylzn53oj2byd.onion```
...
## Created By:
- **Author Name**: Nicolas Hanna
- **Author Contact**: https://www.linkedin.com/in/nicolas--hanna
- **Date**: April 16, 2026
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `April 16, 2026`  | `Nicolas Hanna`   
